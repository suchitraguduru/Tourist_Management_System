...
{
	system("CLS");
    printf("\tPRICE LIST\n=============================\n1. LL - GOA Tours - Rs 14200\n2. JK - SRINAGAR Tours - Rs 19000\n3. SK - SHIMLA Tours - Rs 19500\n4. SHM UTTARAKHAND Vacation - Rs 13400\n"
           "5. AND - ANDAMAN - Rs 29000\n6. BHB - COORG Vacation - Rs 23000\n7. AG - KOVALAM - Rs 12500\n8. ND - UDAIPUR - Rs 17000\n9. RJ - DELHI NCR Vacation - Rs 15300\n10. SI - South US Tour - Rs 250000\n");
}
...
void BookTicket(user *h)
{
    ...
    ShowBrochure();
    float pricelist[]={14200,19000.0,19500.0,13400.0,29000.0,23000.0,12500.0,17000.0,15300.0,250000.0};
    fflush(stdin);
...
void ExitProgram()
{
    printf("Exiting...\nDeveloped By Soumya_Swapna_Suchitra, \n\nBrought To You By SSS\n\nPress \"Enter/Return\" to exit");
    char exitprog;
    fflush(stdin);
    scanf("%c",&exitprog);
}
